...
const ConsentDialog: React.FC<ConsentDialogProps> = ({ open, onAccept, onDecline }) => {
  return (
    <Dialog open={open}>
      <DialogContent className="bg-white dark:bg-gray-900 max-w-md border border-gray-200 dark:border-gray-700">
        <DialogHeader className="mb-4 text-center">
          ...
          <DialogDescription className="text-base text-gray-700 dark:text-gray-300 leading-relaxed">
            Para mejorar nuestro modelo de IA, nos gustaría guardar tu respuesta de manera anónima. 
            No almacenaremos ninguna información personal.
          </DialogDescription>
        </DialogHeader>
