...
const DarkModeButton = () => {
    ...
    return (
        <button
            className="fixed top-4 right-4 p-2 rounded-full bg-white dark:bg-black shadow-lg"
            onClick={toggleTheme}
        >
            {isDarkMode ? (
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="white" stroke="white" xmlns="http://www.w3.org/2000/svg">
