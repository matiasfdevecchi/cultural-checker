...
import { Result } from "@/client-assistance/core/domain/Action";
          ...
          <CardContent className="py-4 px-8">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-8">
              ...
              <ThemedSelect
                ...
                onChange={(value: { value: string; label: string }) => onSelectQuestion(value.value)}
                className="w-full"
                styles={{
                  control: (base: any) => ({
                    ...base,
            ...
            <div className="flex gap-8 pt-8">
              ...
              <div className="flex-1">
                ...
                <div>
                  ...
                  <div className={`flex items-center justify-between w-full p-4 border rounded-lg ${
                    invalidLength ? 'border-red-600' : 'border-gray-300 dark:border-gray-300'
                  }`}>
                ...
                <Button
                  ...
                  disabled={!recorded || counter > question.maxTime || isLoading || loadingExampleId !== null}
                >
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-gray-500 dark:text-gray-400 text-sm font-medium my-4">ó</span>
                <div className="flex-1 w-[1px] bg-gray-200 dark:bg-gray-700"></div>
              </div>
